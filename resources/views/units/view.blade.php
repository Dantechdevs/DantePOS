    ...
    <section class="content">
        <div class="card shadow">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="javascript:void(0);" data-url="{{ route('unit.store') }}"
                    class="btn btn-success btn-sm ml-auto add-unit">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="unitsTable" data-url="{{ route('units.list') }}"
...
<script type="module" src="{{ asset('js/units/unit.js') }}"></script>
<!-- DataTables Buttons -->
