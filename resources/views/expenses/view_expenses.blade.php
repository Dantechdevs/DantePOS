    ...
    <section class="content">
        <div class="card shadow">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('store.expense') }}" class="btn btn-success btn-sm ml-auto">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="expenseTable" data-url="{{ route('expenses.list') }}"
...
<script type="module" src="{{ asset('js/expenses/expense.js') }}"></script>
<!-- DataTables Buttons -->
