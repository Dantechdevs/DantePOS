        ...
        <div class="invoice-meta">
            <div class="left-section">
                ...
                <p><strong>Date:</strong> <span
                        style="direction: ltr; display: inline-block;">{{ date('d M, Y | h:i A', strtotime($saleInvoice['date'])) }}</span>
                </p>
                <p><strong>Status:</strong> <span class="status-badge {{ $statusClass }}">{{ $statusText }}</span>
                </p>
            </div>
                ...
                @if ($saleInvoice['discount'] > 0)
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            @else
                                {{ optional($settings)['currency'] }} {{ number_format($saleInvoice['discount'], 2) }}
                            @endif
                        </td>
                    </tr>
                @endif
