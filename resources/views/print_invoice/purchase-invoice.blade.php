...
<head>
    ...
    <title>{{ $purchaseInvoice['supplier']['name'] ?? '' }} - Purchase Invoice</title>
    <style>
        body {
        ...
        <div class="invoice-details">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div>
                    ...
                    <address><strong>Address:</strong> {{ optional($purchaseInvoice['supplier'])['address'] }}</address>
                ...
                <div style="text-align: right;">
                    <p><strong>Invoice #:</strong> {{ $purchaseInvoice['purchase_no'] }}</p>
                    ...
                    <tbody>
                        ...
                        @if ($purchaseInvoice['other_charges'] > 0)
                            <tr>
                                ...
                                <td style="text-align: right;">{{ number_format($purchaseInvoice['other_charges']) }}
                                </td>
                            </tr>
                        @endif
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">{{ optional($settings)['currency'] }}
                                {{ number_format($purchaseInvoice['grand_total']) }}</td>
                        </tr>
