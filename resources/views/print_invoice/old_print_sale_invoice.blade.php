...
<head>
    ...
    <style>
        ...
        .container {
            ...
            margin: 20mm auto; /* Center on page */
            padding: 20px;
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 company-details">
                ...
                <p><strong>Phone:</strong> Mr. Usman 0333-2072925</p>
                <p><strong>Phone:</strong> Mr. Naveed 0333-8964775, 0343-1074775</p>
            </div>
            <!-- Customer Details (Right Side) -->
            <div class="col-md-6 text-right customer-details">
                <p><strong>Customer:</strong> {{ isset($saleInvoice['customers']['name']) ? $saleInvoice['customers']['name'] : '' }}</p>
                <p><strong>Phone:</strong> {{ isset($saleInvoice['customers']['mobile']) ? $saleInvoice['customers']['mobile'] : '' }}</p>
            </div>
        </div>
        ...
        <div class="invoice-details">
            <table class="table-supply">
                <tr>
                    <td colspan="12" class="text-center"><strong>Invoice #:</strong> SN-{{ $saleInvoice['invoice_no'] }} | <strong>Date:</strong> {{ date('M d, Y', strtotime($saleInvoice['date'])) }} | <strong>Order Status:</strong> {{ $saleInvoice['status'] == 1 ? 'Confirmed' : 'Canceled' }}</td>
                </tr>
            </table>
        </div>
        ...
        <!-- <div class="table-supply"> -->
            <table class="table table-bordered table-sm" style="font-family: Geneva, Verdana,  sans-serif; font-size:14px; color:#000000; line-height: 1rem;">
                <thead>
                    <tr>
...
$result = \App\Http\Helpers\ProductHelper::calculateSoldAndRemaining($totalPiecesSold, $piecesPerBox);
                    ...
                    <tr>
                        ...
                        <td class="text-right"><b>{{ $previous_balance < 0 ? (-1) * $previous_balance . ' CR' : $previous_balance . ' DB' }} </b></td>
                    </tr>
                    <tr>
                        <td colspan="4" class="text-left"><strong>Total Balance</strong></td>
                        <td class="text-right"><b>{{ $customerBalance < 0 ? (-1) * $customerBalance . ' CR' : $customerBalance . ' DB' }}</b></td>
                    </tr>
                </tbody>
            </table>
        <!-- </div> -->
