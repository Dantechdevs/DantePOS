...
<body>
    @foreach ($invoices as $data)
        ...
        <div class="container">
            <!-- Header -->
            <h1 class="text-center" style="font-size: 16px; font-weight:bold; font-family: 'Noto Nastaliq Urdu';">رسید
                فروخت</h1>
            <div class="header">
                <div class="logo">
            ...
            <div class="invoice-meta">
                <div class="right-section">
                    ...
                    <p><strong>تاریخ:</strong>
                        <span style="display: inline-block; direction: ltr; unicode-bidi: embed;">
                            {{ date('d M, Y | h:i A', strtotime($saleInvoice['date'])) }}
                        </span>
                    </p>
                    <p><strong>حالت:</strong> <span class="status-badge {{ $statusClass }}">{{ $statusText }}</span>
                    </p>
                </div>
            ...
            <!-- Totals Section -->
            <!-- Updated Totals Section - Place this right after the products table -->
            ...
            <!-- QR Code Section - This will automatically flow to the right -->
            <!-- QR Code and Notes -->
            <div class="qr-section">
                ...
                <div class="qr-code">
                    ...
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data={{ urlencode($url) }}"
                        alt="کیو آر کوڈ">
                    <p>انوائس کی تصدیق کے لیے سکین کریں</p> --}}
                </div>
