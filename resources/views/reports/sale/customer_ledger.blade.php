                ...
                <div class="card-body">
                    <form id="purchaseForm">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <label for="customer_id" class="form-label">Customer <font class="required_field">*</font></label>
                        ...
                        <div class="form-group text-right">
                            <button type="button" id="searchButton" data-url="{{ route('report.customer.ledger.list') }}"
                                class="btn btn-info">
...
@push('custom-script')
    ...
    <script type="module" src="{{ asset('js/reports/customer_ledger.js') }}"></script>
@endpush
