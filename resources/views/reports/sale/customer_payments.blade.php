...
@section('title', '| Customer Payments Report')
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Customer Payments Report</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <form id="purchaseForm">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <select id="type" class="form-control select2 form-control-sm"
                                    style="width: 100%;">
                        ...
                        <div class="form-group text-right">
                            <button type="button" id="searchButton" data-url="{{ route('report.customer.payments.list') }}"
                                class="btn btn-info">
...
@push('custom-script')
    ...
    <script type="module" src="{{ asset('js/reports/customer_payments.js') }}"></script>
@endpush
