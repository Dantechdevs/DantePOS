            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Supplier Payments Report</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <form id="purchaseForm">
                        ...
                        <div class="form-group text-right">
                            <button type="button" id="searchButton" data-url="{{ route('report.supplier.payments.list') }}"
                                class="btn btn-info">
...
@push('custom-script')
    ...
    <script type="module" src="{{ asset('js/reports/supplier_payments.js') }}"></script>
@endpush
