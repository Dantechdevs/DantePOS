                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    <input type="text" placeholder="DD-MM-YYYY" class="form-control form-control-sm"
                                        name="startDate" id="startDate" value="{{date('d-m-Y')}}" readonly>
                                </div>
                                <label for="endDate" class="col-sm-2 col-form-label">To Date</label>
                                <div class="col-sm-10 col-md-4">
                                    <input type="text" placeholder="DD-MM-YYYY" class="form-control form-control-sm"
                                        name="endDate" id="endDate" value="{{date('d-m-Y')}}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="category_id" class="col-sm-2 col-form-label">Categoreis</label>
                                <div class="col-sm-10 col-md-4">
        ...
        $(document).on('click', '#show_report', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data == 'false') {
                        $.notify("there is no supplier data found!", {
                            globalPosition: 'top right',
                            className: 'error'
                        });
                        return false;
