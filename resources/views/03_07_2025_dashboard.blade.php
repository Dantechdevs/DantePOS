                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="card shadow bg-success text-white animate-card">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text fs-4"><strong>{{ number_format($sale_total) }} {{optional($settings)['currency']}}</strong></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="card shadow bg-dark text-white animate-card">
                        <div class="card-body text-center">
                            ...
                            <h5>Stock Value</h5>
                            <p class="card-text fs-4"><strong>{{number_format($totalAmount)}} {{optional($settings)['currency']}}</strong></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="card shadow bg-secondary text-white animate-card">
                        <div class="card-body text-center">
                            ...
                            <h5>Total Cash</h5>
                            <p class="card-text fs-4"><strong>{{ number_format($totalCash) }} {{optional($settings)['currency']}}</strong></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="card shadow bg-danger text-white animate-card">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text fs-4"><strong>{{ number_format($total_expenses) }} {{optional($settings)['currency']}}</strong></p>
                        </div>
                    </div>
                </div>
            </div>
