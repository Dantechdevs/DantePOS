...
$(function () {
    ...
    const expenseUrl = $('#expenseTable').data('url');
    ...
    initializeDataTable({
        ...
        columns: [
            ...
            { data: 'expense_for', name: 'expense_for', title: 'Expense For' },
            { data: 'amount', name: 'amount', title: 'Expense Amount' },
    ...
    $(document).on('click', '.delete', function (e) {
        ...
        const tableId = 'expenseTable'; // ID of your DataTable
